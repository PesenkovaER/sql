...
В ходе выполнения лабораторной работы были изучены и практически применены различные движки таблиц ClickHouse: MergeTree, ReplacingMergeTree и SummingMergeTree.

Все задания выполнены в соответствии с вариантом 15: созданы таблицы с правильными типами данных, вставлены тестовые данные (150 строк продаж, 10 товаров, метрики за 3 дня), выполнены аналитические запросы. Продемонстрирована работа партиционирования, дедупликации версий в ReplacingMergeTree и автоматического суммирования в SummingMergeTree.

На все контрольные вопросы даны ответы.
